...
public:
    ...
    std::vector<float> Zlep1dZ;
    std::vector<float> Zlep1dxy;
    std::vector<float> Zlep1mvaFall17V2IsoWP90;
    std::vector<float> Zlep1iso;
    ...
    std::vector<float> Zlep2dZ;
    std::vector<float> Zlep2dxy;
    std::vector<float> Zlep2mvaFall17V2IsoWP90;
    std::vector<float> Zlep2iso;
    ...
    float dZL1, dxyL1, dZL2, dxyL2;
    float mvaFall17V2Iso_WP90_L1, mvaFall17V2Iso_WP90_L2;
    float isoL1, isoL2;
