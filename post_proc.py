...
testfile = "root://cms-xrd-global.cern.ch//store/data/Run2018A/DoubleMuon/MINIAOD/UL2018_MiniAODv2_GT36-v1/2430000/00267D27-22E1-C143-A50C-5FC81AE13C86.root"
...
if testfile.find("UL2018") != -1:
    year = 2018
if testfile.find("UL2017") != -1:
    year = 2017
