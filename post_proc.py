...
if testfile.find("SingleMuon") != -1 or testfile.find("EGamma") != -1 or testfile.find("SingleElectron") != -1 or testfile.find("DoubleMuon") != -1 or testfile.find("MuonEG") != -1 or testfile.find("DoubleEG") != -1:
  ...
  # if testfile.find("RunIISummer19UL17NanoAOD") != -1: year = 'UL2017'
  ...
  # p=PostProcessor(".",[testfile],"",None,[HZZAnalysisModule(),fatJetCorrector()],provenance=True,fwkJobReport=False,maxEntries=entriesToRun,prefetch=DownloadFileToLocalThenRun)
